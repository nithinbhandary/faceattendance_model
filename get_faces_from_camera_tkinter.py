...
class Face_Register:
    ...
    def GUI_info(self):
        ...
        tk.Label(self.frame_right_info,
                ...
                text="Step1: Enter Student Details").grid(row=5, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
    ...
    #             command=self.GUI_clear_data).grid(row=6, column=0, columnspan=3, sticky=tk.W, padx=5, pady=2)
        ...
        #tk.Label(self.frame_right_info,
        #         font=self.font_step_title,
        #         text="Input Roll No").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)

        tk.Label(self.frame_right_info, text="Enter Roll No: ").grid(row=6, column=0, columnspan=3, sticky=tk.W, padx=5, pady=2)
        self.input_rollno.grid(row=6, column=1, sticky=tk.W, padx=0, pady=2)

        #tk.Label(self.frame_right_info,
        #         font=self.font_step_title,
        #         text="Input name ").grid(row=7, column=0, columnspan=2, sticky=tk.W, padx=5, pady=20)
    ...
    def check_existing_faces_cnt(self):
        ...
        # Start from person_1
            ...
            self.existing_faces_cnt = 0
    #insert data in studentdetail db
    def add_to_db(self):
        ...
        if existing_entry:
            ...
            cursor.execute("INSERT INTO studentdetails (name,roll_no) VALUES (%s, %s)", (self.input_name_char, self.input_rollno_int))
            conn.commit()
        conn.close()
    ...
    def create_face_folder(self):
        ...
        self.existing_faces_cnt = self.input_rollno_int
